    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            icon: const Icon(Icons.notifications_none_outlined, color: Colors.white, size: 23),
            onPressed: () {},
          ),
          IconButton(
            icon: const Icon(Icons.search_outlined, color: Colors.white, size: 24),
            onPressed: () {
              ...
              children: [
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      child: !authVm.isLoggedIn
                          ? const Icon(Icons.account_circle, size: 42, color: AppColors.textSecondary)
                          : (user.avatarUrl.isEmpty
                              ? Text(user.name.isNotEmpty ? user.name[0] : 'U', style: const TextStyle(fontSize: 22, color: Colors.white))
                              : null),
                    ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            authVm.isLoggedIn ? user.email : '@tubetune • Sign in to sync',
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Icon(
                                        authVm.isLoggedIn ? Icons.logout : Icons.login,
                                        size: 13,
                                        color: Colors.white,
                                      ),
                                      const SizedBox(width: 4),
                                      Text(
                                        authVm.isLoggedIn ? 'Sign Out' : 'Sign In',
                                ...
                                child: Container(
                                  ...
                                  child: const Row(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(width: 4),
                                      Text('Filters & Time', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: Colors.white)),
                                    ],
                                  ),
                                ),
                              ),
                  ...
                  children: [
                    ...
                    if (playerVm.watchHistory.isNotEmpty)
                      InkWell(
                        ...
                        child: const Text(
                          'Clear all',
                          style: TextStyle(fontSize: 13, color: AppColors.youtubeRed, fontWeight: FontWeight.w600),
                        ),
                      ),
                  ],
                ),
                ...
                ListTile(
                  ...
                  leading: Container(
                    ...
                    child: const Icon(Icons.watch_later_outlined, color: Colors.white, size: 22),
                  ),
                  title: const Text('Watch Later', style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w500)),
                  subtitle: Text('${playerVm.watchLater.length} videos', style: const TextStyle(color: Color(0xFFAAAAAA), fontSize: 12)),
                  trailing: const Icon(Icons.arrow_forward_ios_rounded, size: 14, color: Color(0xFFAAAAAA)),
                ),
                ...
                ListTile(
                  ...
                  leading: Container(
                    ...
                    child: const Icon(Icons.thumb_up_outlined, color: Colors.white, size: 22),
                  ),
                  title: const Text('Liked videos', style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w500)),
                  subtitle: Text('${playerVm.likedVideoIds.length} videos', style: const TextStyle(color: Color(0xFFAAAAAA), fontSize: 12)),
                  trailing: const Icon(Icons.arrow_forward_ios_rounded, size: 14, color: Color(0xFFAAAAAA)),
                ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          InkWell(
                            ...
                            child: const Text('Configure', style: TextStyle(fontSize: 12, color: AppColors.accentCyan, fontWeight: FontWeight.bold)),
                          ),
                        ],
                      ),
                      ...
                      const SizedBox(height: 8),
                      _buildStatusRow(Icons.timer, 'Daily Auto-Lock', settingsVm.timerService.isScheduleEnabled ? 'ACTIVE SCHEDULE' : 'Off', AppColors.accentAmber),
                    ],
                  ),
                ),
                const SizedBox(height: 24),
  ...
  Widget _buildStatusRow(IconData icon, String label, String status, Color color) {
    return Row(
      children: [
        ...
        const SizedBox(width: 8),
        Text(label, style: const TextStyle(fontSize: 13, color: Color(0xFFAAAAAA))),
        const Spacer(),
